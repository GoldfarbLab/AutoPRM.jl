...
"""
function getNearest(transition::Transition, masses::AbstractArray{Union{Missing, T}}, peak::Int; δ::U = 0.0) where {T,U<:AbstractFloat}
...
"""
function matchPeaks!(matches::Vector{FragmentMatch{T}}, Transitions::Vector{Transition}, masses::AbstractArray{Union{Missing, T}}, intensities::AbstractArray{Union{Missing, T}}, δ::U, scan_idx::UInt32, ms_file_idx::UInt32) where {T,U<:AbstractFloat}
...
"""
function matchPeaks(Transitions::Vector{Transition}, masses::AbstractArray{Union{Missing, T}}, intensities::AbstractArray{Union{Missing, T}}; δs::Vector{U} = zeros(Float32, (1, )), scan_idx = UInt32(0), ms_file_idx = UInt32(0)) where {T,U<:AbstractFloat}
